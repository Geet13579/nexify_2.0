...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="bg-white flex items-center justify-between font-regular  w-full 2xl:px-60 md:px-10 sm:px-5 h-20 z-40 border-b sticky overflow-hidden top-0">
        <Link href={'/'}>
