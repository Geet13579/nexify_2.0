                                ...
                                <header className=" leading-tight ">
                                    <ul className='list-none px-5 '>
                                        ...
                                        <li className="text-2xl font-medium">
                                            <p className=" text-sm text-gray-500 pb-2 pt-5 font-regular text-justify">
                                        ...
                                        <li className="text-2xl font-medium font-regular  py-5">
                                            <span className="inline-block align-middle text-[14px] sm:text-[13px]  text-black-400 border-[1px] py-1 px-5 rounded-lg border-gray-400">
                                                +91 98447 64343
                                            </span>
                                        </li>
                                        ...
                                        <li className="text-2xl font-medium">
                                            <p className=" text-md sm:text-sm text-black-500 pb-2 pt-5">
                                                Follow us:
                                            </p>
                                        ...
                                        <li className="text-2xl font-medium">
                                            <p className=" text-sm text-gray-500 pb-2 pt-5 font-regular">
                                    ...
                                    <form className="w-full max-w-lg contents flex-contents" onSubmit={submitHandler}>
                                        <div className="flex flex-wrap -mx-3 mb-6">
                                            ...
                                            <div className="w-full md:w-1/2 px-3">
                                                ...
                                                <input onChange={handleChange} name="last_name" className="font-regular placeholder-white text-[15px] sm:text-[10px]  placeholder-opacity-100 appearance-none block w-full bg-transparent text-white border border-white-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-transparent" id="grid-first-name" type="text" placeholder="Last Name" />
                                            </div>
                                        </div>
                                        <div className="flex flex-wrap -mx-3 mb-6">
                                            <div className="w-full px-3">
                                                ...
                                                <input onChange={handleChange} name="email" className="font-regular placeholder-white text-[15px] sm:text-[10px]  placeholder-opacity-100 appearance-none block w-full bg-transparent text-white border border-white-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-transparent" id="grid-first-name" type="text" placeholder="Email" />
                                        ...
                                        <div className="flex flex-wrap -mx-3 mb-6">
                                            <div className="w-full px-3">
                                                ...
                                                <input onChange={handleChange} name= "phone_number" className=" font-regular placeholder-white text-[15px] sm:text-[10px]  placeholder-opacity-100 appearance-none block w-full bg-transparent text-white border border-white-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-transparent" id="grid-first-name" type="number" placeholder="IND | 123456789" />
                                        ...
                                        <div className="flex flex-wrap -mx-3 mb-6">
                                            <div className="w-full px-3">
                                                ...
                                                <textarea onChange={handleChange} name="message" className=" font-regular placeholder-white text-[15px] sm:text-[10px]  placeholder-opacity-100 appearance-none block w-full bg-transparent text-white border border-white-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-transparent" id="grid-first-name" placeholder="Type a Message....." />


                                            </div>
                                        </div>

                                        <button type="submit" className='w-full h-[50px] sm:h-[30px] bg-white rounded-full text-primary font-bold '>Enquire Now</button>
                                        <p className='text-md sm:text-sm px-5 p-2 text-white font-regular'>By contacting us, you agree to our Terms of Service and privacy policy.</p>
