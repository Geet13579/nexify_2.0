...
export default function Header() {
  return (
    ...
    <div className='xl:h-[70vh] sm:h-[50vh]  w-full bg-cover bg-center 2xl:p-40 xl:p-20  md:p-10  sm:p-5'  style={{ backgroundImage: `url('/Hero Section (1).png')`}}>

<div className="flex flex-col items-start max-w-xl 2xl:pt-[30px] 2xl:leading-[54px] sm:pt-[100px] 2xl:pl-[18px] sm:pl-[10px] ">
